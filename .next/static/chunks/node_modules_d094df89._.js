...
function _createCurveFields(type, CURVE) {
    let curveOpts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
function weierstrassN(CURVE) {
    let curveOpts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    function pointFromBytes(bytes) {
        ...
        if (length === LC && (head === 0x02 || head === 0x03)) {
            ...
            throw new Error("bad point: got length ".concat(length, ", expected compressed=").concat(LC, " or uncompressed=").concat(LU));
        }
    }
...
function ecdsa(Point, ecdsaOpts) {
    let curveOpts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    ...
    const hmac_ = ecdsaOpts.hmac || function(key) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$hmac$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hmac"])(ecdsaOpts.hash, key, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concatBytes"])(...msgs));
    };
    const { Fp, Fn } = Point;
    ...
    function aValidRS(title, num) {
        if (!Fn.isValidNot0(num)) throw new Error("invalid signature ".concat(title, ": out of range 1..CURVE.n"));
    }
    /**
...
function weierstrassN(CURVE) {
    ...
    Point.Fn = Fn;
    const bits = Fn.BITS;
    const wnaf = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$abstract$2f$curve$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wNAF"](Point, curveOpts.endo ? Math.ceil(bits / 2) : bits);
    return Point;
}
function weierstrassPoints(c) {
    const { CURVE, curveOpts } = _weierstrass_legacy_opts_to_new(c);
...
function ecdsa(Point, hash) {
    ...
    const { Fp, Fn } = Point;
    const { ORDER: CURVE_ORDER, BITS: fnBits } = Fn;
    const seedLen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$abstract$2f$modular$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMinHashLength"])(CURVE_ORDER);
    const lengths = {
        secret: Fn.BYTES,
        public: 1 + Fp.BYTES,
     ...
     */ class Signature {
        static fromBytes(bytes) {
            let format = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'compact';
            if (format === 'compact') {
                const L = Fn.BYTES;
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(bytes, L * 2);
        ...
        toBytes() {
            let format = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'compact';
            if (format === 'compact') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concatBytes"])(Fn.toBytes(this.r), Fn.toBytes(this.s));
            if (format === 'der') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hexToBytes"])(DER.hexFromSig(this));
            throw new Error('invalid format');
        }
     ...
     */ function randomSecretKey() {
        let seed = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : randomBytes_(seedLen);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$abstract$2f$modular$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapHashToField"])(seed, CURVE_ORDER);
    }
    const utils = {
        isValidSecretKey,
        isValidPublicKey,
     ...
     */ function sign(msgHash, secretKey) {
        ...
        const drbg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createHmacDrbg"])(hash.outputLen, Fn.BYTES, hmac_);
        return drbg(seed, k2sig); // Steps B, C, D, E, F, G
    }
    // Enable precomputes. Slows down first publicKey computation by 20ms.
    Point.BASE.precompute(8);
     ...
     */ function verify(signature, msgHash, publicKey) {
        ...
        if (format === undefined) {
            ...
            if (format === 'compact' || format === 'der') {
                if (typeof sg !== 'string' && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBytes"])(sg)) throw new Error('"der" / "compact" format expects Uint8Array signature');
                _sig = Signature.fromBytes((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ensureBytes"])('sig', sg), format);
            } else if (format === 'js') {
...
function schnorrGetExtPubKey(priv) {
    ...
    let d_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$abstract$2f$weierstrass$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_normFnElement"])(Point.Fn, priv);
...
//# sourceMappingURL=node_modules_d094df89._.js.map