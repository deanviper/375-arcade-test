...
"[project]/node_modules/@walletconnect/modal-core/node_modules/proxy-compare/dist/index.modern.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@walletconnect/modal-core/node_modules/valtio/esm/vanilla.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@walletconnect/modal-core/node_modules/proxy-compare/dist/index.modern.js [app-ssr] (ecmascript)");
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/@walletconnect/modal-core/node_modules/valtio/esm/vanilla.mjs")}`;
    }
};
;
...
const buildProxyFunction = (objectIs = Object.is, newProxy = (target, handler)=>new Proxy(target, handler), canProxy = (x)=>isObject(x) && !refSet.has(x) && (Array.isArray(x) || !(Symbol.iterator in x)) && !(x instanceof WeakMap) && !(x instanceof WeakSet) && !(x instanceof Error) && !(x instanceof Number) && !(x instanceof Date) && !(x instanceof String) && !(x instanceof RegExp) && !(x instanceof ArrayBuffer), defaultHandlePromise = (promise)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markToTrack"])(snap, true);
    ...
    Reflect.ownKeys(target).forEach((key)=>{
        ...
        if (refSet.has(value)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markToTrack"])(value, false);
    ...
    const handler = {
        ...
        set (target, prop, value, receiver) {
            ...
            removePropListener(prop);
            if (isObject(value)) {
                value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUntracked"])(value) || value;
            }
            let nextValue = value;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@walletconnect/modal-core/node_modules/valtio/esm/vanilla.mjs [app-ssr] (ecmascript)");
;
const o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    history: [
        "ConnectWallet"
    ],
    view: "ConnectWallet",
    ...
    state: o,
    subscribe (e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribe"])(o, ()=>e(o));
    },
    push (e, t) {
    ...
    isMobile () {
        return "undefined" < "u" ? Boolean(window.matchMedia("(pointer:coarse)").matches || /Android|webOS|iPhone|iPad|iPod|BlackBerry|Opera Mini/u.test(navigator.userAgent)) : !1;
    },
    isAndroid () {
...
}, _ = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https")), r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    enabled: _,
    userSessionId: "",
    events: [],
    ...
    state: r,
    subscribe (e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribe"])(r.events, ()=>e((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["snapshot"])(r.events[r.events.length - 1])));
    },
    initialize () {
...
}, c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    chains: void 0,
    ...
    state: c,
    subscribe (e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribe"])(c, ()=>e(c));
    },
    setChains (e) {
        c.chains = e;
    },
...
}, W = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    projectId: "",
    ...
    state: W,
    subscribe (e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribe"])(W, ()=>e(W));
    },
    setConfig (e) {
        var t, s;
...
const N = a.isMobile(), d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    wallets: {
        listings: [],
        total: 0,
        page: 1
...
}, I = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    open: !1
}), se = {
    state: I,
    subscribe (e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribe"])(I, ()=>e(I));
    },
    async open (e) {
        return new Promise((t)=>{
...
const C = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
...
}, g = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["proxy"])({
    open: !1,
    message: "",
    variant: "success"
}), oe = {
    state: g,
    subscribe (e) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribe"])(g, ()=>e(g));
    },
    openToast (e, t) {
...
class d {
    constructor(e){
        this.openModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ModalCtrl"].open, this.closeModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ModalCtrl"].close, this.subscribeModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ModalCtrl"].subscribe, this.setTheme = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ThemeCtrl"].setThemeConfig, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ThemeCtrl"].setThemeConfig(e), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ConfigCtrl"].setConfig(e), this.initUi();
    }
    async initUi() {
        if ("undefined" < "u") {
            ...
            document.body.insertAdjacentElement("beforeend", e), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OptionsCtrl"].setIsUiLoaded(!0);
        }
    }
}
;
...
//# sourceMappingURL=node_modules_%40walletconnect_f798dd59._.js.map